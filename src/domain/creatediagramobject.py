...
class ObjetoDiagramaUnifilar:
    ...
    def checagem_sistemas(self):
        self.quantidade_sistemas = (
            self.dados_projeto.quantidade_sistemas_instalados
        )
    ...
    @staticmethod
    def get_multiplicador(tensao_inversor: str):
    ...
    @staticmethod
    def get_tensao(tensao_inversor: str):
        if tensao_inversor == "monofasico":
            return 220
        elif tensao_inversor == "trifasico":
            return 380
    ...
    def texto_disjuntor_protecao1(self, sistema_instalado):
        ...
        corrente_saida_inversor = Calculos.get_corrente_saida(
            ...
            * sistema1.quantidade_inversor,
            multiplicador=multiplicador,
            inversor_tensao=tensao,
        )

        disjuntor_protecao1 = Calculos.disjuntor_protecao(
    ...
    def cabo_inversor1(self, sistema_instalado):
        ...
        cabo_inversor1 = Calculos.cabo_energia_inversor(
            corrente_saida_inversor
        )
    ...
    def texto_paineis(self, sistema_instalado):
        ...
        if not sistema.quantidade_total_placas_do_sistema.quantidade_placas2:
            quantidade_placa = (
                sistema.quantidade_total_placas_do_sistema.quantidade_placas
            )
            marca_placa = sistema.placa.marca_placa
            modelo_placa = sistema.placa.modelo_placa
            self.potencia_total_placas += (
                sistema.placa.potencia_placa * quantidade_placa
            )
            return (
                f"{quantidade_placa}x " + f" {marca_placa} \n {modelo_placa}"
            )
            ...
            quantidade_placa2 = (
                sistema.quantidade_total_placas_do_sistema.quantidade_placas2
            )
            self.potencia_total_placas += (
                sistema.placa.potencia_placa * quantidade_placa1
            )
            self.potencia_total_placas += (
                sistema.placa2.potencia_placa * quantidade_placa2
            )
            ...
            return (
                f"{quantidade_placa1}x "
                + f" {marca_placa} \n {modelo_placa} + \n"
                + f"{quantidade_placa2}x "
                + f" {marca_placa2} \n {modelo_placa2}"
            )
    ...
    def texto_inversor1(self, sistema_instalado):
        ...
        self.potencia_total_inversores += (
            potencia_inversor * quantidade_inversor
        )
    ...
    def construir_dados_diagrama(self) -> RetornoProjetoDiagrama:
        DOIS_INVERSORES = 2
        TRES_INVERSORES = 3
        if self.quantidade_sistemas == DOIS_INVERSORES:
            texto_disjuntor_protecao2 = self.texto_disjuntor_protecao1(
                self.dados_projeto.sistema_instalado2
            )
            texto_paineis2 = self.texto_paineis(
                self.dados_projeto.sistema_instalado2
            )
            cabo_inversor2 = self.cabo_inversor1(
                self.dados_projeto.sistema_instalado2
            )
            sistema_instalado2 = self.dados_projeto.sistema_instalado2
            texto_inversor2 = self.texto_inversor1(
                self.dados_projeto.sistema_instalado2
            )
        ...
        elif self.quantidade_sistemas == TRES_INVERSORES:
            texto_disjuntor_protecao2 = self.texto_disjuntor_protecao1(
                self.dados_projeto.sistema_instalado2
            )
            texto_disjuntor_protecao3 = self.texto_disjuntor_protecao1(
                self.dados_projeto.sistema_instalado3
            )
            texto_paineis2 = self.texto_paineis(
                self.dados_projeto.sistema_instalado2
            )
            texto_paineis3 = self.texto_paineis(
                self.dados_projeto.sistema_instalado3
            )
            cabo_inversor2 = self.cabo_inversor1(
                self.dados_projeto.sistema_instalado2
            )
            cabo_inversor3 = self.cabo_inversor1(
                self.dados_projeto.sistema_instalado3
            )
            sistema_instalado2 = self.dados_projeto.sistema_instalado2
            ...
            texto_inversor3 = self.texto_inversor1(
                self.dados_projeto.sistema_instalado3
            )
        ...
        return RetornoProjetoDiagrama(
            ...
            texto_disjuntor_protecao1=self.texto_disjuntor_protecao1(
                self.dados_projeto.sistema_instalado1
            ),
            texto_disjuntor_protecao2=texto_disjuntor_protecao2,
            texto_disjuntor_protecao3=texto_disjuntor_protecao3,
            texto_paineis1=self.texto_paineis(
                self.dados_projeto.sistema_instalado1
            ),
            texto_paineis2=texto_paineis2,
            texto_paineis3=texto_paineis3,
            cabo_inversor1=self.cabo_inversor1(
                self.dados_projeto.sistema_instalado1
            ),
            ...
            texto_inversor1=self.texto_inversor1(
                self.dados_projeto.sistema_instalado1
            ),
